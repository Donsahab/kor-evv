...
public class RespiteCareActivitiesAdapter extends RecyclerView.Adapter<RespiteCareActivitiesAdapter.ViewHolder> {

    private Context mContext;
    private List<ServiceModel> mDataSet;
    DatabaseHandler db ;

    public RespiteCareActivitiesAdapter(Context context, List<ServiceModel> list){
        mContext = context;
        mDataSet = list;
        ...
        holder.ll1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(holder.imageView.getVisibility()==View.GONE) {
                    ...
                    db.addSelectedByUserRespiteCare(new ServiceModel(scheduleModel.getId(),scheduleModel.getName(),""));
                    holder.textView.setTextColor(Color.WHITE);
                }else {
                    holder.imageView.setVisibility(View.GONE);
                    db.deleteSelectedByIDRespiteCare(scheduleModel.getId());
